...
void setup()
{
  ...
  //
/**  
  TempPlot1.SetTitle("Temp");
  TempPlot1.SetXlabel("Time");
  TempPlot1.SetYlabel("Temp C");
  TempPlot1.SetXRange(1/30);
  TempPlot1.SetSeriesProperties("Temperature", Plot::Red, Plot::Solid, 2, Plot::FilledCircle);
...
//    }      
    ...
    int smalladdr = (addr[6] << 8) | addr[7];
    TempPlot1.SendData("Temp1", oneWireSensors.getTempCByIndex(0));
